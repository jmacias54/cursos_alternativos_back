package com.mx.alternativecourses.api.application.configuration.handler;

import com.mx.alternativecourses.api.application.configuration.handler.response.Error;
import com.mx.alternativecourses.api.application.configuration.handler.response.ResponseError;
...
import com.mx.alternativecourses.api.domain.exception.TokenRefreshException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ResponseError> tokenRefreshException(final Exception ex, final HttpServletRequest request) {
		logger.error("TokenRefreshException Occured:: URL " + request.getRequestURI() + getParameters(request));
		logger.error("Error detail:: ", ex);
